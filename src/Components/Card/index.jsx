...
function Card({ price, title, category, image, id, description }) {
    ...
    return (
        <article className='cursor-pointer w-56 h-60 rounded-lg p-4'>
            ...
            <figure className='relative mb-2 w-full h-4/5'>
                ...
                <img onClick={() => { setProductDetails({ price, title, category, image, id, description }) }} className='w-full h-full object-cover rounded-lg' src={image} alt={title} />
